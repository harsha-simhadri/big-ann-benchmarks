...
SUBM_MAPPING            = \
{
    ...
    "cuanns_multigpu": {
        ...
        "results_dir":  ( "%s/nvidia/multigpu/public/results_nv_multi_public_new_power_merged__all__deep1B" % CACHE_RESULTS_TOPLEVEL ) if PUBLIC else \
            ( "%s/nvidia/multigpu/private/results_nv_multi_priv_new_power_all" % CACHE_RESULTS_TOPLEVEL ),
        "export_fname": "public_w_cache_detect.csv" if PUBLIC else "private_w_cache_detect.csv",
        "cache_detect": True,
        "not_part":     [ ],
    ...
    "cuanns_ivfpq": {
        ...
        "results_dir" : ( "%s/nvidia/ivfpq/public/results_nv_ivfpq_public_new_power_all" %  CACHE_RESULTS_TOPLEVEL ) \
            if PUBLIC else  "%s/nvidia/ivfpq/private/results_nv_ivfpq_priv_new_power_merge__msspacev_error__just_msspacev" % CACHE_RESULTS_TOPLEVEL,
        "export_fname": "public_w_cache_detect.csv" if PUBLIC else \
            "private_w_cache_detect.csv",
        "cache_detect": True,
        "not_part":     [ ],
