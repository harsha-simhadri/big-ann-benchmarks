...
PATH=/usr/bin:$PATH LD_LIBRARY_PATH="./gsl_resources_prof:$HOME/.local/lib/python3.6/site-packages/faiss" PYTHONPATH="./gsl_resources_prof:$HOME/.local/lib/python3.6/site-packages/faiss" python3 run.py --t3  --nodocker --definitions t3/gemini/algos.yaml --dataset deep-1B --runs 1
