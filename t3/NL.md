...
|Rank|Submission                                          |Team                          |Hardware               |Status |Score  |Deep1B|BigANN|MSTuring|MSSpace|Text2Image|FBSimSearchNet|
|----|----------------------------------------------------|------------------------------|-----------------------|-------|-------|------|------|--------|-------|----------|--------------|
|   1|[faiss_t3](../t3/faiss_t3/README.md)                                  |faiss_t3                       |NVidia GPU                |final|baseline|$DPD1 |$785,282.45 |$1,018,332.30   |$873,460.84  |$1,298,436.77     |$429,634.84         |
|   2|[gemini](../t3/gemini/README.md)                                  |gemini                       |LedaE APU                |inprog|$2,561,736.98|$DPD2 |$626,785.91 |$286,578.81   |$685,704.76  |$4,857,248.23     |-         |
|   3|[-](-)                                  |-                       |-                |-|-|$DPD3 |$BAC3 |$MTC3   |$MSC3  |$TIC3     |$FBC3         |
|   4|                                                   -|                             -|                      -|      -|      -|     -|     -|       -|      -|         -|             -|
|   5|                                                   -|                             -|                      -|      -|      -|     -|     -|       -|      -|         -|             -|
|   6|                                                   -|                             -|                      -|      -|      -|     -|     -|       -|      -|         -|             -|
|   7|                                                   -|                             -|                      -|      -|      -|     -|     -|       -|      -|         -|             -|
