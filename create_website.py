...
from benchmark.plotting.plot_variants import (all_plot_variants
                                                   as plot_variants)
...
def build_index_site_without_data(j2_env, file_name):
     with open(args.outputdir + "index.html", "w") as text_file:
        text_file.write(j2_env.get_template("summary.html").
                        render(title="Big ANN Benchmarks"))
...
build_index_site_without_data(j2_env, "index.html")
