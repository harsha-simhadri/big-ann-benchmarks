...
class hwtl_sdu_anns_stream(BaseStreamingANN):
    def __init__(self, metric, index_params):
        self.name = "hwtl_sdu_anns_stream"
    ...
    def create_index_dir(self, dataset):
        ...
        index_dir = os.path.join(index_dir, 'hwtl_sdu_anns_stream')
        os.makedirs(index_dir, mode=0o777, exist_ok=True)
    ...
    def __str__(self):
        return f'HWTL_SDU_ANNS_stream({self.index_name(), self._query_args})'
