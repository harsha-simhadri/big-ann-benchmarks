...
from neurips23.streaming.candy_flann.candy_flann import candy_flann as candy_flann_streaming
import torch

class candy_flann(BaseCongestionDropANN):
    def __init__(self, metric, index_params):
        super().__init__([candy_flann_streaming(metric, index_params)], metric, index_params)
        self.metric = metric
