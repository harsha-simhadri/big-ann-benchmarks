...
|Streaming| DiskANN     | ?? (recall@10)           |  `python3 run.py --dataset msturing-10M --algorithm diskann --neurips23track streaming --runbook_path neurips23/streaming/delete_runbook.yaml` |
...
python run.py --neurips23track streaming --algorithm diskann --dataset msturing-10M --runbook_path neurips23/streaming/simple_runbook.yaml
```
