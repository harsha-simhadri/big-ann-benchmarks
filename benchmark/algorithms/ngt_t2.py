...
class NGT(BaseANN):
    ...
    def setIndexPath(self, dataset):
        self._path = f"data/indices/trackT2/algo.NGT:q{self._quantization}-s{self._quantization_sample}-b{self._blob}-rs{self._num_of_r_samples}-ri{self._num_of_r_iterations}"
