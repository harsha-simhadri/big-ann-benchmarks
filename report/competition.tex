...
model\cite{deep1b-link,BERT}.  The ANNS problem is widely studied in
...
~\cite{CoverTree,babenko2014additive,Faiss17,Weber98,ECCV18,HNSW16,PQ11,Arya93,Indyk98,onng,scann,puffinn}
for some recent works, and also the survey
articles~\cite{samet2006foundations, LSHSurvey08, LearningToHash18,
...
gold-standard benchmark site~\cite{Benchmark} that compares almost all
