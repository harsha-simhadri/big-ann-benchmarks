...
\title[Big-ANNS]{Results of the Billion-Scale Approximate Nearest Neighbor Search Challenge}
...
\author{%
 ...
 \Name{George Williams} \Email{gwilliams@gsitechnology.com}\\
 \Name{Martin Aum\"uller} \Email{maau@itu.dk}\\
 \Name{Matthijs Douze} \Email{matthijs@fb.com}\\
 \Name{Artem Babenko} \Email{artem.babenko@phystech.edu}\\
 \Name{Dmitry Baranchuk} \Email{dbaranchuk@yandex-team.ru}\\
 \Name{Qi Chen} \Email{cheqi@microsoft.com}\\
 \Name{Ravishankar Krishnaswamy} \Email{rakri@microsoft.com}\\
 \Name{Gopal Srinivasa} \Email{gopalsr@microsoft.com}\\
 \Name{Suhas Jayaram Subramanya} \Email{suhasj@cs.cmu.edu}\\
 \Name{Jingdong Wang} \Email{jingdw@microsoft.com}\\
