...
\begin{abstract}
  ...
  compares ANNS algorithms at billion-scale by hardware cost, accuracy and
  ...
  The competition involves three tracks. 
  The standard hardware track T1 evaluates algorithms on an Azure VM
  ...
  leaderboards were created based on recall as well as
